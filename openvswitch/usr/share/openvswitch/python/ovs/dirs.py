...
PKGDATADIR = os.environ.get("OVS_PKGDATADIR", """C:/openvswitch/usr/share/openvswitch""")
RUNDIR = os.environ.get("OVS_RUNDIR", """C:/openvswitch/var/run/openvswitch""")
LOGDIR = os.environ.get("OVS_LOGDIR", """C:/openvswitch/var/log/openvswitch""")
BINDIR = os.environ.get("OVS_BINDIR", """C:/openvswitch/usr/bin""")
...
if not DBDIR:
    ...
    if sysconfdir:
        ...
        DBDIR = """C:/openvswitch/etc/openvswitch"""
